...
def map_creation(matrix):
    global list_block, list_block_x, list_food, list_food_x, list_food_y, start_x, enemy_list, enemy_list_x, enemy_list_direction, finish
    list_block.clear()
    list_block_x.clear()
    list_food.clear()
    list_food_x.clear()
